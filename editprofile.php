                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" readonly class="form-control" id="userType" name="userType" placeholder="Digite o seu email" value="<?= $userData->userType ?>">
                        </div>
                        <br>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="bio" id="bio" rows="5" placeholder="Conte quem você é, os rolês que curte e onde mora..."><?= $userData->bio ?></textarea>
                        </div>
                    </div>
                </div>
            </form>
                ...
                <div class="col-md-4">
                    ...
                    <form action="<?= $BASE_URL ?>user_process.php" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" id="password" name="confirmpassword" placeholder="Confirme a sua nova senha">
                        </div>
                        <br>
